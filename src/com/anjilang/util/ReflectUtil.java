...
public class ReflectUtil {
	 ...
	 * @throws Exception
	 */
	public static void copy(Object from, Object to, String flg) throws Exception {
	...
	/**
	 * 获取vo对象的filedNameList方法
	 * @param vo
	 * @param flg
	 * @return
	 */
	public static JSONObject getFileName(Object vo, String flg) {
		Class<?> voClass = vo.getClass();
		try {
			 //获取vo对象方法getFiledName
			 Method getFileName = voClass.getDeclaredMethod("filedNameList");
			//调用get方法获取旧的对象的值
	         Object value = getFileName.invoke(vo);
