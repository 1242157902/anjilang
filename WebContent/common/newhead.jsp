	...
	<div class="login">
             <ul id="af-log">
             		...
             		<c:if test="${sessionScope['audit'] == null}">
			      		<li class="num1">
			         	 <p><a href="<c:url value='/regist/init.do' />">营养师注册 </a></p>
			     	   </li>
			     	   </c:if>
			      	</c:if>
                 <li>
                   ...
                   <c:if test="${sessionScope['type'] != 1}">
                    ...
                    <div class="userinfo">
                     <em></em> 
                      <dl>
                         <dd class="title"><a href="<c:url value='/user/setAccountHead.do' />"><img src="<c:url value="/${sessionScope['header']}  "/>" /></a><p><a href="<c:url value='/user/setAccountMod.do' />">${sessionScope['realName']}</a>
                         <br/>
                         	<c:if test="${sessionScope['type'] == 1}">
	  ...
	  <c:otherwise>
	  		 ...
	  		 <div class="qq"><a href="<c:url value='/login/qqLogin.do '/>"><img src ="<c:url value='/images/qq.png'/> "/></a></div>
 			 <div class="xlweb"><a href="<c:url value='/login/weiboLogin.do '/>"><img src="<c:url value='/images/xlweb.png '/> "/></a></div>	 
 			 <div class="top-in-r">
			       <ul>
			      	<%-- <c:if test="${sessionScope['userId'] != null}">
			      		<li class="num1">
			        ...
			        <p><a href="<c:url value='/login/login.jsp' />">登录丨</a></p>
			        
			        </li>
			        
			         <li class="num2">
			            
			            <p><a href="<c:url value='/regist/userreg.jsp' />">用户注册</a></p>
			       		<%-- <p><a href="<c:url value='/login/qqLogin.do '/>"><img src ="images/qq.png "/></a></p> --%>
			        </li>
			       </ul>
			  </div>
	  </c:otherwise>
...
<div class="nav">
     ...
     <div class="nav_l">
       ...
       <div class="nav_t">
            <a href="<c:url value='/' />" class="center">首页</a>
            <%-- <a href="<c:url value='/ask/'/>">医生问答</a>
            <a href="<c:url value="/doc/" />">找医生</a> --%>
            <a href="http://123.56.84.207:81/jmshop"  target="_blank" >膳食商城</a>
            <span></span>
