			...
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/author/save.do' />" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="profile" name="profile" type="text" value="" placeholder="简介" class="form-control">
									</div>
								</div>
								<div class="form-group">
