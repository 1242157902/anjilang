		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>推荐作者</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/author/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">姓名</label>
									<div class="col-md-9">
										<input id="name" name="name" type="text" value="${author.name }" placeholder="姓名" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">简介</label>
									<div class="col-md-9">
										<input id="profile" name="profile" type="text" value="${author.profile }" placeholder="简介" class="form-control">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-9">
										...
										<span id ="showPic"><img style="width: 500px;height: 304px;" src="<c:url value="/${book.pic }"/>"/></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="url" name="url" type="text" value="${author.url }" placeholder="访问地址" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										...
										<input type="hidden" id="pic" name="pic" value="${author.pic }">
