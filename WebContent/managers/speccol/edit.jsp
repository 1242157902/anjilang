		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>首页安吉郎专栏</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/speccol/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">标题</label>
									<div class="col-md-9">
										<input id="title" name="title" type="text" value="${specCol.title }" placeholder="标题" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">内容</label>
									<div class="col-md-9">
										<%-- <input id="content" name="content" type="text" value="${specCol.content }" placeholder="内容" class="form-control"> --%>
										<textarea rows="4" cols="30" id="content" name="content" placeholder="内容" class="form-control">${specCol.content }</textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-9">
										...
										<span id ="showPic"><img style="width: 500px;height: 304px;" src="<c:url value="/${specCol.pic }"/>"/></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="sort" name="sort" type="text" value="${specCol.sort }" placeholder="默认为0,则不在首页显示" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">url</label>
									<div class="col-md-9">
										<input id="url" name="url" type="text" value="${specCol.url }" placeholder="访问地址" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										...
										<input type="hidden" id="pic" name="pic" value="${specCol.pic }">
										<input type="hidden" id="id" name="id" value="${specCol.id }">
									</div>
								</div>
							</fieldset>
						</form>
