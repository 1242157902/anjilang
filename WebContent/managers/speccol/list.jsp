...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">安吉郎专栏管理
						<a href="<c:url value='/managers/speccol/add.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
						<a href="#" onclick="deleteObj()" class="btn btn-primary" style="position: relative;float: right;margin:10px;">删除</a>
					</div>
					
					<form action="<c:url value='/speccol/del.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/speccol/list.do' />"  
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/speccol/toedit.do?id="+id+"'  />";
        }/*,
