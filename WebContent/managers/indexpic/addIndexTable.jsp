...
<script type="text/javascript" src="<c:url value='/managers/js/ajaxfileupload.js' />"></script>
	...
	function ajaxFileUpload() {
	    $.ajaxFileUpload({
	        url: '<c:url value="/upload/image.do?path=indextable" />', 
	        type: 'post',
		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>首页table页</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/index/savepic.do' />" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="sortNum" name="sortNum" type="text" placeholder="默认为0,则不在首页显示" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">url</label>
									<div class="col-md-9">
										<input id="accessUrl" name="accessUrl" type="text" value="" placeholder="访问地址" class="form-control">
									</div>
								</div>
