...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">首页商城列表
						<a href="<c:url value='/managers/indexpic/addIndexShop.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
					...
					<form action="<c:url value='/index/deletepic.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							...
							<table 
							data-toggle="table" 
							data-url="<c:url value='/index/piclist.do?type=2' />"  
							...
							data-id-field="id">
							    ...
							    <tr>
							        ...
							        <th data-field="picUrl" data-formatter="picUrlmatter" data-sortable="true">首页商城图片地址</th>
							        <th data-field="sortNum" data-sortable="true">首页商城图片展示排序</th>
							        <th data-field="nowprice" data-sortable="true">现价</th>
							        <th data-field="pastprice" data-sortable="true">原价</th>
							        <th data-field="typename" data-sortable="true">类型</th>
							        <th data-field="productname" data-sortable="true">名称</th>
							        <th data-field="accessUrl" data-sortable="true">商城访问地址</th>
	...
	function picUrlmatter(value, row, index) {
		...
		return [
	            '<img src="<c:url value="/'+picUrl+'" />" height="160px;"  width="120px;" />'
	        ].join('');
	}
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/index/toedit.do?id="+id+"&type="+2+"'  />";
        }/*,
