...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">首页商城列表
						<a href="<c:url value='/managers/indexpic/addIndexDoctor.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
					...
					<form action="<c:url value='/index/deletepic.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							...
							<table data-toggle="table" data-url="<c:url value='/index/piclist.do?type=3' />"  
							...
							data-sort-name="name" data-sort-order="desc"  data-id-field="id">
							    ...
							    <tr>
							        ...
							        <th data-field="picUrl" data-formatter="picUrlmatter" data-sortable="true">首页特约营养师图片地址</th>
							        <th data-field="sortNum" data-sortable="true">首页特约营养师图片展示排序</th>
							        <th data-field="name" data-sortable="true">姓名</th>
							        <th data-field="hospital" data-sortable="true">工作医院</th>
							        <th data-field="accessUrl" data-sortable="true">访问地址</th>
	...
	function picUrlmatter(value, row, index) {
		...
		return [
	            '<img src="<c:url value="/'+picUrl+'" />" height="120px;"  width="90px;" />'
	        ].join('');
	}
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/index/toedit.do?id="+id+"&type="+3+"'  />";
        }/*,
