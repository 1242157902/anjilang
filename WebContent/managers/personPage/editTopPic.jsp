...
<script type="text/javascript" src="<c:url value='/managers/js/ajaxfileupload.js' />"></script>
	...
	function ajaxFileUpload() {
	    $.ajaxFileUpload({
	        url: '<c:url value="/upload/image.do?path=personPageTop&contentType=text/html" />', 
	        type: 'post',
		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>编辑个人中心顶部图片</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/personPage/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">上传图片</label>
									<div class="col-md-9">
										<input type="file" id="file" name="file" onchange="ajaxFileUpload()">
										<img alt="" src="<c:url value='/${pictureTop.picUrl }' />" id="showPic" width="500px;" height="400px;" name="showPic">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										...
										<input type="hidden" id="picture" name="picture" value="${pictureTop.picUrl }">
										<input type="hidden" id="id" name="id" value="${pictureTop.id }">
									</div>
								</div>
							</fieldset>
						</form>
