		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>添加个人中心顶部图片</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/personPage/save.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">上传图片</label>
									<div class="col-md-9">
										<input type="file" id="file" name="file" onchange="ajaxFileUpload()">
										<img alt="" src="" id="showPic" style="display: none" width="500px;" height="400px;" name="showPic">
									</div>
								</div>
