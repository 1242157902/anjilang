...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">推荐书籍管理
						<a href="<c:url value='/managers/bookrecommendation/add.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
						<a href="#" onclick="deleteObj()" class="btn btn-primary" style="position: relative;float: right;margin:10px;">删除</a>
					</div>
					
					<form action="<c:url value='/book/delete.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/book/list.do' />"  
							...
							data-sort-name="name" data-sort-order="desc"  data-id-field="id">
							    ...
							    <tr>
							        ...
							        <th data-field="bookname" data-sortable="true">标题</th>
							        <th data-field="pic"  data-formatter="picUrlmatter" data-sortable="true">图片</th>
							        <th data-field="bookURL" data-sortable="true">URL</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/book/toEdit.do?id="+id+"'  />";
        }/*,
