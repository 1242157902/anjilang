		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>推荐书籍</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/book/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">书名</label>
									<div class="col-md-9">
										<input id="bookname" name="bookname" type="text" value="${book.bookname }" placeholder="标题" class="form-control">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="bookurl" name="bookurl" type="text" value="${book.bookURL }" placeholder="访问地址" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										...
										<input type="hidden" id="pic" name="pic" value="${book.pic }">
