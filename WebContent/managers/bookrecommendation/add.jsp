			...
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/book/save.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">书名</label>
									<div class="col-md-9">
										<input id="bookname" name="bookname" type="text" value="" placeholder="标题" class="form-control">
									</div>
								</div>
								<div class="form-group">
