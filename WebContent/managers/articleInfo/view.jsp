		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>文章详情</div>
						...
						<form class="form-horizontal" action="<c:url value='/infor/save.do' />" method="post">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-9">
									<input id="title" readonly="readonly" name="title" type="text" value="${articleInfo.title}" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">文章发布人</label>
									<div class="col-md-9">
									<input id="title" readonly="readonly" name="title" type="text" value="${articleInfo.user.userName}" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">发布时间</label>
									<div class="col-md-9">
										<input id="title" readonly="readonly" name="title" type="text" 
											value="<fmt:formatDate value="${articleInfo.createDate }" pattern="yyyy-MM-dd HH:mm:ss" />" class="form-control">
									</div>
								</div>
								<div class="form-group">
