		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>文章发布</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/articleInfo/articleInfoSave.do' />" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" id="content"   placeholder="请输入详细内容" rows="20" name="content"></textarea>
