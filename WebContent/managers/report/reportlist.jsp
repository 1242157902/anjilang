...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">举报内容列表
						<%-- <a href="<c:url value='/managers/friendlink/add.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a> --%>
						<a href="#" onclick="deleteObj()" class="btn btn-primary" style="position: relative;float: right;margin:10px;">删除</a>
					</div>
					
					<form action="<c:url value='/report/delete.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/report/queryAjax.do' />"  
							    ...
							    <tr>
							       <th data-field="ids" data-checkbox="true" ></th>
							        <th data-field="id" data-visible="false"></th>
 									  <th data-field="content" data-sortable="true">具体内容</th>  
							        <th data-field="reason" data-sortable="true">举报原因</th>
							        <th data-field="reasonDetail" data-sortable="true">详细原因</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/report/delete.do?id="+id+"'  />";
        }
    };
</script>
