			...
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/infor/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">资讯标题</label>
									<div class="col-md-9">
									<input id="title" name="title" type="text" value="${information.title }" placeholder="请输入标题" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" id="content"   placeholder="请输入详细内容" rows="5" name="content">${information.content }</textarea>
							...
							<input type="hidden" id="typeId" name="typeId" value="${information.typeId }">
						</form>
					</div>
				</div>
				</div>
