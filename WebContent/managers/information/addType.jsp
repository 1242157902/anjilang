		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>添加资讯分组</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/inforType/save.do' />" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="detailTitle" name="detailTitle" type="text" placeholder="请输入详细标题" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" id="detailContent" name="detailContent" placeholder="请输入详细内容" rows="5"></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="url" name="url" type="text" placeholder="请输入地址" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="numn" name="num" type="text" placeholder="默认为0,则不在首页显示" class="form-control">
									</div>
								</div>
