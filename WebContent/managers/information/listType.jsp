...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">资讯分组列表
						<a href="<c:url value='/managers/information/addType.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
						<a href="#" onclick="deleteObj()" class="btn btn-primary" style="position: relative;float: right;margin:10px;">删除</a>
					</div>
					
					<form action="<c:url value='/inforType/delete.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/inforType/queryAjax.do' />"  
							...
							data-sort-name="name" data-sort-order="desc"  data-id-field="id">
							    ...
							    <tr>
							        ...
							        <th data-field="title" data-sortable="true">资讯分组标题</th>
							        <th data-field="detailTitle" data-sortable="true">资讯分组详细标题</th>
							        <th data-field="detailContent" data-sortable="true">资讯分组详细内容</th>
							        <th data-field="num" data-sortable="true">首页显示顺序</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/inforType/toEdit.do?id="+id+"'  />";
        },
