		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>添加友情链接</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/friendLink/save.do' />" method="post">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="url" name="url" type="text" placeholder="请输入url" class="form-control">
									</div>
								</div>
