...
<body>
				...
				<div class="panel panel-default">
					...
					<form action="<c:url value='/friendLink/delete.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/friendLink/queryAjax.do' />"  
							...
							data-sort-name="name" data-sort-order="desc"  data-id-field="id">
							    ...
							    <tr>
							       <th data-field="ids" data-checkbox="true" ></th>
							        ...
							        <th data-field="url" data-sortable="true">url地址</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/friendLink/toEdit.do?id="+id+"'  />";
        }
    };
</script>
