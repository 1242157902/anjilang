		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>修改友情链接</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/friendLink/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">标题</label>
									<div class="col-md-9">
									<input id="title" name="title" type="text" value="${friendLink.title }" placeholder="请输入标题" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
									<input id="url" name="url" type="text" value="${friendLink.url }" placeholder="请输入url" class="form-control">
									</div>
								</div>
