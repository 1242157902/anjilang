...
<script type="text/javascript">
	function ajaxFileUpload() {
	    $.ajaxFileUpload({
	        url: '<c:url value="/upload/image.do?path=indexseniordochead" />', 
	        type: 'post',
		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>首页知名专家</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/seniordoctor/edit.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">姓名</label>
									<div class="col-md-9">
										<input id="name" name="name" type="text" value="${seniorDoctor.name }" placeholder="姓名" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">描述</label>
									<div class="col-md-9">
										<input id="description" name="description" type="text" value="${seniorDoctor.description }" placeholder="描述" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">上传头像</label>
									<div class="col-md-9">
										<input type="file" id="file" name="file" onchange="ajaxFileUpload()">
										<span id ="showPic"><img style="width: 500px;height: 304px;" src="<c:url value="/${seniorDoctor.header }"/>"/></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="sort" name="sort" type="text" value="${seniorDoctor.sort }" placeholder="默认为0,则不在首页显示" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">url</label>
									<div class="col-md-9">
										<input id="url" name="url" type="text" value="${seniorDoctor.url }" placeholder="访问地址" class="form-control">
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										...
										<input type="hidden" id="header" name="header" value="${seniorDoctor.header }">
										<input type="hidden" id="id" name="id" value="${seniorDoctor.id }">
									</div>
								</div>
							</fieldset>
						</form>
