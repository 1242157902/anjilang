			...
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/seniordoctor/save.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">姓名</label>
									<div class="col-md-9">
										<input id="name" name="name" type="text" value="" placeholder="姓名" class="form-control">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-3 control-label" for="message">描述</label>
									<div class="col-md-9">
										<input id="description" name="description" type="text" value="" placeholder="描述" class="form-control">
									</div>
								</div>
								<div class="form-group">
