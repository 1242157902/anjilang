...
<body>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">资讯列表
						<a href="<c:url value='/managers/disease/add.jsp' />" class="btn btn-primary" style="position: relative;float: right;margin:10px;">添加</a>
						<a href="#" onclick="deleteObj()" class="btn btn-primary" style="position: relative;float: right;margin:10px;">删除</a>
					</div>
					
					<form action="<c:url value='/disease/delete.do' />" id="body" name="body" method="post">
						<div class="panel-body">
							<table data-toggle="table" data-url="<c:url value='/disease/queryAjax.do' />"  
							...
							data-sort-name="name" data-sort-order="desc"  data-id-field="id">
							    ...
							    <tr>
							        ...
							        <th data-field="picUrl" data-formatter="picUrlmatter" data-sortable="true">图片</th>
							        <th data-field="diseaseName" data-sortable="true">疾病名称</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            var id=row["id"];
            window.location.href="<c:url value='/disease/toEdit.do?id="+id+"'  />";
        }
    };
</script>
