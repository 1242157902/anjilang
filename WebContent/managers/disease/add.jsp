		...
		<div class="row">
			<div class="col-md-8" style="width:100%">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="glyphicon glyphicon-envelope"></span>添加疾病</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<c:url value='/disease/save.do' />" method="post">
							<fieldset>
								<div class="form-group">
									<label class="col-md-3 control-label" for="name">疾病标题</label>
									<div class="col-md-9">
									<input id="name" name="name" type="text" placeholder="请输入标题" class="form-control">
									</div>
								</div>
