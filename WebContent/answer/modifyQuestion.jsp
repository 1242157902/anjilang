...
<form id="subForm" action="modifyQuestion.do" method="post">
...
<input type="text" class="txt" name="title" style="height: 32px;width:768px;" value="<%=question.getTitle()%>"/>
   <h2><span>问题</span>详细内容</h2>
   
   <div class="tool_ask_box">
   <div class="tool_ask_textarea">
       <textarea name="content"><%=question.getContent()%></textarea>
   ...
   <div class="tool_ask_message"><a id="submit" href="#">修改问题</a></div>
   </div>
</div>
</form>
<div class="rightBox">
